...
Card::Card(string name): Cube(name)
{
	...
	vertex vertex_list[] =
	{
		//X - Y - Z
		//FRONT FACE
		{Vector3D(-0.2f,-0.01f,-0.2f),    Vector3D(1,0,0),  Vector3D(0.2f,0,0) },
		{Vector3D(-0.2f,0.01f,-0.2f),    Vector3D(1,1,0), Vector3D(0.2f,0.2f,0) },
		{ Vector3D(0.1f,0.01f,-0.2f),   Vector3D(1,1,0),  Vector3D(0.2f,0.2f,0) },
		{ Vector3D(0.1f,-0.01f,-0.2f),     Vector3D(1,0,0), Vector3D(0.2f,0,0) },

		//BACK FACE
		{ Vector3D(0.1f,-0.01f,0.2f),    Vector3D(0,1,0), Vector3D(0,0.2f,0) },
		{ Vector3D(0.1f,0.01f,0.2f),    Vector3D(0,1,1), Vector3D(0,0.2f,0.2f) },
		{ Vector3D(-0.2f,0.01f,0.2f),   Vector3D(0,1,1),  Vector3D(0,0.2f,0.2f) },
		{ Vector3D(-0.2f,-0.01f,0.2f),     Vector3D(0,1,0), Vector3D(0,0.2f,0) }
...
void Card::draw(int width, int height)
{
	constant cc;
	Matrix4x4 temp;
